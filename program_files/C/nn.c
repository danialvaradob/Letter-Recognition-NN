 ...
 * 
 */ 
void execute_training(int numTrainingSets, char path_td[], char path_od[], double* hiddenWeights, 
   ...
   /*
    ...
    for (int e = 0; e < epochs; e++) {
        for (int batch = 0; batch <= amount_of_batches; batch++) {
            ...
            execute_training(batch_size, batch_path, label_path, hiddenWeights, outputWeights,
